...
model_name = 'trained_models/ngsim_generator_decompose_us1011_nei3_epoch294.tar'
...
for epoch_num in range(pretrainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_ngsim_nei3&4_bestval_294.tar')
