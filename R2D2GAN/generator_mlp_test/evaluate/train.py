...
model_name = 'trained_models/ngsim_generator_decompose_us1011_nei3_epoch198.tar'
...
trSet = ngsimDatasetGan(mat_file=real_set_name, enc_size=256, t_f=args_g['out_length'],
...
valSet = ngsimDataset('../../data/ValSet-us1011-gan-smooth-nei3&4.mat',grid_size=args['grid_size'],
...
for epoch_num in range(pretrainEpochs):
    ...
    for i, data in enumerate(trDataloader):
        ...
        st_time = time.time()
        real_scene, mask, index_division,maneuver,scale = data
        ...
        # temp_t = time.time()
        # for j in range(100):
        #     temp_scene = net_g_compose(pos_condition,index_division)
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_ngsim_nei3&4_bestval_198.tar')
